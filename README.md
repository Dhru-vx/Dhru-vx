...
<div>
  ...
  <img src="https://img.shields.io/badge/OpenPyXL-1F4E79?style=for-the-badge"/>
</div>
...
###  Power Plant Operational Efficiency Dashboard
- Developed Power BI dashboards for operational KPI monitoring.
- Implemented ARIMA-based forecasting for predictive maintenance.
- Reduced manual monitoring by **40%** using automated alerts.

###  Movie Trend Analysis
- Analyzed 7,000+ movie records using Python and Pandas.
- Identified trends in genres, ratings, and release patterns.

---

##  Education
- **B.Tech in Computer Engineering** – Suryodaya College of Engineering & Technology (CGPA: 7.14)
- Class XII – Ujjwal Junior College  
- Class X – Vidarbha Buniyadi School

---

## Certification
- Salesforce AI Specialist (Oct 2024)
